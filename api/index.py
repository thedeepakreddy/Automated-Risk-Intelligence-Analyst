...
from api._classifier import build_client, verify_model
...
async def lifespan(app: FastAPI):
    ...
    if not gemini_api_key():
        ...
        # Catch a retired or inaccessible model name here, where it is one loud
        # line, rather than as a quiet per-article fallback every cycle.
        await asyncio.to_thread(verify_model, build_client())
    tasks = [
