    ...
    <div className="space-y-8">
      ...
      <div className="bg-[#09090b] border border-zinc-800 rounded-2xl p-8 flex flex-col items-center justify-center text-center relative overflow-hidden">
        ...
        <p className="text-zinc-400 max-w-2xl text-sm leading-relaxed">
          Currently analyzing <strong className="text-zinc-300 font-medium">real-time global financial news</strong> across <strong className="text-zinc-300 font-medium">Equities, Bonds, Commodities, Crypto, FX and Real Estate</strong>. Python engines handle ingestion, deduplication and scoring, while Gemini classifies each headline by risk type and severity to quantify systemic risk.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-zinc-900 rounded-xl overflow-hidden border border-zinc-800">
        <div className="bg-[#09090b] p-6">
          ...
          <ul className="space-y-2.5 text-sm text-zinc-400">
            <li className="flex items-center gap-2"><span className="w-1 h-1 bg-white rounded-full"></span> <span className="text-zinc-300 font-medium">Public RSS feeds:</span> Financial news</li>
            <li className="text-xs text-zinc-500 ml-3">Reuters, Bloomberg, CNBC, Yahoo Finance, MarketWatch, BBC</li>
            <li className="flex items-center gap-2 mt-2"><span className="w-1 h-1 bg-white rounded-full"></span> <span className="text-zinc-300 font-medium">Deduplicated</span> on title + URL</li>
            <li className="text-xs text-zinc-500 ml-3">Up to 20 new headlines / 30 mins</li>
          </ul>
        </div>
        <div className="bg-[#09090b] p-6">
          <div className="text-zinc-500 uppercase tracking-widest text-[10px] font-semibold mb-4 flex items-center gap-2">
          ...
          <ul className="space-y-2.5 text-sm text-zinc-400">
            ...
            <li className="flex items-center gap-2"><span className="w-1 h-1 bg-indigo-400 rounded-full"></span> Weighted Master Risk Scoring (40/30/30)</li>
          </ul>
        </div>
        <div className="bg-[#09090b] p-6">
          <div className="text-zinc-500 uppercase tracking-widest text-[10px] font-semibold mb-4 flex items-center gap-2">
